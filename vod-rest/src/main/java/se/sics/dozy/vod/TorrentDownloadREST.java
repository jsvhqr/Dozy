...
public class TorrentDownloadREST implements DozyResource {
    ...
    public Response pendingUpload(FileInfoJSON fileInfo) {
        ...
        TorrentDownloadEvent.Request request = new TorrentDownloadEvent.Request(fileInfo.getName(), new IntIdentifier(fileInfo.getOverlayId()));
        try {
            ...
            DozyResult<TorrentDownloadEvent.Response> result = futureResult.get();
